...
interface CropperData {
      ...
      loading: boolean,
      realWidth: number, // only for when autoSizing is on
      realHeight: number, // only for when autoSizing is on
      chosenFile: null,
      useAutoSizing: boolean,
}
  ...
  methods: {
    ...
    _setSize() {
      ...
      if (canvas) {
        ...
        canvas.style.width = (this.useAutoSizing ? this.realWidth : this.width) + "px";
        canvas.style.height = (this.useAutoSizing ? this.realHeight : this.height) + "px";
      }
    ...
    _clipPathFactory(x: number, y: number, width: number, height: number) {
      let ctx = this.ctx;
      let radius =
